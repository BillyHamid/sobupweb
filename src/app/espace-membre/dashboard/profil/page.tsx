  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden">
        {/* Bannière */}
        <div className="h-32 relative" style={{ background: "linear-gradient(135deg, #0B3D38 0%, #065E52 70%, #31B9AE 130%)" }}>
          <div className="absolute -bottom-12 left-8 flex items-end gap-4">
            <div className="relative">
              <div className="w-24 h-24 rounded-full flex items-center justify-center text-white font-black text-3xl border-4 border-white shadow-lg"
                style={{ background: "linear-gradient(135deg, #31B9AE, #7EEAE4)" }}>
                {user.avatar}
              </div>
              <button className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-white shadow-md flex items-center justify-center hover:scale-110 transition-transform">
        ...
        <div className="pt-16 pb-6 px-8 flex items-start justify-between flex-wrap gap-4">
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              ...
              {user.isBureau && (
                <span className="text-xs font-bold px-2.5 py-1 rounded-full" style={{ background: "#fff7ed", color: "#e67e22" }}>
                  Bureau Exécutif
                </span>
              )}
              <span className="text-xs font-bold px-2.5 py-1 rounded-full" style={{ background: "#f5f3ff", color: "#7c3aed" }}>
                Membre depuis {user.joinedAt}
              </span>
            </div>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-white hover:-translate-y-0.5 transition-all"
      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div className="flex border-b border-gray-100">
          {[
            ...
            { key: "professionnel", label: "Profil professionnel" },
            { key: "securite", label: "Sécurité du compte" },
          ].map((t) => (
